...
omap3621_edp1_config :    unconfig
	@./mkconfig omap3621_edp1 arm omap3 omap3621_edp1; \
	echo "#define CONFIG_SDRAM_MT46H32M32LFCM" >> ./include/config-2.h; \
	cat ./include/config.h >> ./include/config-2.h; \
	mv ./include/config-2.h ./include/config.h

omap3621_edp1_2G_config :    unconfig
	@./mkconfig omap3621_edp1 arm omap3 omap3621_edp1; \
	echo "#define CONFIG_SDRAM_MT46H64M32LF" >> ./include/config-2.h; \
	cat ./include/config.h >> ./include/config-2.h; \
	mv ./include/config-2.h ./include/config.h

##&*&*&*20110223_Peter ++
omap3621_edp1_elpida_2G_config :    unconfig
	@./mkconfig omap3621_edp1 arm omap3 omap3621_edp1; \
	echo "#define CONFIG_DDR_EDK2232CBBH_50_F" >> ./include/config-2.h; \
	cat ./include/config.h >> ./include/config-2.h; \
	mv ./include/config-2.h ./include/config.h	
##&*&*&*20110223_Peter --
...
clobber:	clean
	...
	rm -fr include/asm/proc include/asm/arch
