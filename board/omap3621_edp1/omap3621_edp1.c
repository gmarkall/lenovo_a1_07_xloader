...
{
//&*&*&*20110223_Peter ++	
	/* Set DDR drive strength SDRC_LOADDATA/SDRC_HIGHDATA/SDRC_ADDRCTR/SDRC_NCS0/SDRC_NCS1 */
	__raw_writel(0xF8000000, CONTROL_PROG_IO0);
//&*&*&*20110223_Peter --
...
#define MUX_DEFAULT()\
	...
	/*MUX_VAL(CP(GPMC_A3),        (IDIS | PTD | DIS | M0))*/ /*GPMC_A3, GPIO-36, MODEM_POW_EN(EVT2), configure it in uboot*/\
	MUX_VAL(CP(GPMC_A4),        (IDIS | PTD | DIS | M0)) /*GPMC_A4*/\
	MUX_VAL(CP(GPMC_A5),        (IDIS | PTD | EN  | OFF_OUT_PD | M4)) /*GPMC_A5, gpio-38, LCD_BL_EN*/\
	MUX_VAL(CP(GPMC_A6),        (IDIS | PTD | DIS | M0)) /*GPMC_A6*/\
	MUX_VAL(CP(GPMC_A7),        (IDIS | PTD | DIS | M0)) /*GPMC_A7*/\
	MUX_VAL(CP(GPMC_A8),        (IDIS | PTD | DIS | M0)) /*GPMC_A8*/\
	MUX_VAL(CP(GPMC_A9),        (IDIS | PTU | EN | M4)) /*GPMC_A9, gpio-42, CHRG_CEn*/\
...
/*	MUX_VAL(CP(GPMC_D13),       (IEN  | PTD | DIS | M0))*/ /*GPMC_D13*/\
	MUX_VAL(CP(GPMC_D14),       (IDIS  | PTD | EN | M4)) /*GPMC_D14, gpio-50, OTG_EN_1V8*/\
/*	MUX_VAL(CP(GPMC_D15),       (IEN  | PTD | DIS | M0))*/ /*GPMC_D15*/\
  ...
  /*MUX_VAL(CP(GPMC_nCS7),      (IEN  | PTU | EN  | M1))*/ /*GPMC_IO_DIR lab*/\
	...
	MUX_VAL(CP(GPMC_nBE1),      (IDIS  | PTD | DIS | M4)) /*GPMC_nBE1, gpio-61, USB_MODE*/\	
	...
	MUX_VAL(CP(DSS_DATA18),     (IEN  | PTD | DIS | M4)) /*GIO-2*/\
	MUX_VAL(CP(DSS_DATA19),     (IEN  | PTD | DIS | M4)) /*GIO-3*/\
	MUX_VAL(CP(DSS_DATA20),     (IEN  | PTD | DIS | M4)) /*GIO-5*/\
	MUX_VAL(CP(DSS_DATA21),     (IEN  | PTD | DIS | M4)) /*GIO-6*/\
