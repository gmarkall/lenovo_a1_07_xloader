...
#define CONFIG_3630SDP	         1    /* working on Labrador & 512 Memory */
...
#define PRCM_CLK_CFG2_400MHZ     1    /* VDD2=1.15v - 166MHz DDR */
...
/* Micron(MT29F4G16ABC) 16-bit 512MB, large page NAND chip*/
...
#define READ_NAND(adr)	(*(volatile u8 *)GPMC_NAND_DATA_0);
#define NAND_WAIT_READY()
#define NAND_WP_OFF()  \
	do { *(volatile u32 *)(GPMC_CONFIG) |= 0x00000010; } while (0)
#define NAND_WP_ON()  \
