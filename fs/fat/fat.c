...
//&*&*&*20110218_SJ1, Add x-loader read MBR 1st partition start block.
typedef union {
	unsigned long i;
	struct {
		unsigned char b[4];
...
//&*&*&*20110218_SJ2, Add x-loader read MBR 1st partition start block.
...
fat_register_device(block_dev_desc_t *dev_desc, int part_no)
{
    ...
    (CONFIG_COMMANDS & CFG_CMD_USB) || (CONFIG_COMMANDS & CFG_CMD_MMC) || defined(CONFIG_SYSTEMACE)
		 ...
		 */
//&*&*&*20110218_SJ1, Add x-loader read MBR 1st partition start block offset.
#if 0
		part_offset=63;		
#else
		{
			UNION part_start_sector;
			part_start_sector.b[0] = buffer[0x1c6];
			part_start_sector.b[1] = buffer[0x1c6+1];
			part_start_sector.b[2] = buffer[0x1c6+2];
			part_start_sector.b[3] = buffer[0x1c6+3];
			part_offset = part_start_sector.i;
		}
#endif
//&*&*&*20110218_SJ2, Add x-loader read MBR 1st partition start block offset.
		//part_offset=0;
		cur_part = 1;
#endif
	}
